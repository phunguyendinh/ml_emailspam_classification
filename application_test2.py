...
def read_words_from_file(words_file='vietnamese_words.txt'):
    """Read the list of words from a file."""
    with open(words_file, 'r', encoding='utf-8') as file:
        return [line.strip() for line in file.readlines()]

# Count occurrences of words in email content
def count_words_in_email(email_content, words_file='vietnamese_words.txt'):
...
def prepare_features(email_content, words_file='vietnamese_words.txt'):
...
model = load_model(r"MODEL/naive_bayes_model2.joblib")
